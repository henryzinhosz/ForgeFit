    ...
    <div className="min-h-screen pb-24 md:pt-20 bg-background">
      ...
      <main className="max-w-screen-xl mx-auto px-4 py-8 space-y-8">
        <header className="space-y-4">
          ...
          <p className="text-muted-foreground">Explore mais de 50 exercícios selecionados para diversas modalidades.</p>
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="bg-card border-border">
                      ...
                      <div className="space-y-4 pt-4">
                        <div className="aspect-video bg-muted rounded-xl overflow-hidden border border-white/5">
                          <img 
