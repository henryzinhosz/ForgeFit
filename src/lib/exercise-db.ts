...
export const EXERCISE_DATABASE: Exercise[] = [
  ...
  { id: '50', title: 'Simulado TAF', category: 'Calistenia', instructions: 'Faça o máximo de dos exercicios do taf, corrida, flexão, abdominal e barra fixa', imageId: 'simulado-taf-img' },
